					...
					<div class="footer-container tt-wrap">
						<div class="row">
							...
							<div class="col-sm-12 col-md-3">
								...
								<!-- Begin footer block (text) -->
								<div class="footer-block">
									<h4 class="f-block-heading">Biz haqimizda</h4>
									<div class="f-block-text padding-right-30">
									Sayt Toshkent viloyati Chirchiq davlat pedagogika instituti Tasviriy sa'nat va muxandislik grafikasi kafedrasi tomonidan ishga tushurilgan.
									</div>
								</div>
								<!-- End footer block -->
							...
							<div class="row">
								<div class="col-md-6">
									...
									<div class="footer-bottom-col-left">
										&copy; TSMG 18/1 Kechki Fayziyev.R
									</div>
