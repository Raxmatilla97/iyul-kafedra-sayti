...
@section('content')
    ...
    <section id="page-header" class="ph-sm">
        ...
        <div class="page-header-image parallax-6 bg-image" style="background-image: url({{ asset('front/assets/img/unnamed.jpg')}});">
            ...
            * Use class "fade-out-scroll-1" up to "fade-out-scroll-6" to enable fade out effect if page scrolls (no effect on mobile devices!).
            ...
            <div class="page-header-caption ph-cap-light parallax-5">
                <div class="ph-title-wrap">
                    <h1 class="page-header-title">To'liq e'lonlar sahifasi</h1>
                </div>
                <div class="ph-subtitle-wrap">
                    <h2 class="page-header-subtitle">Kafedradagi barcha e'lonlari ro'yxati</h2>
                </div>
                                    ...
                                    <div class="isotope-item">
                                        ...
                                        <article class="blog-list-item">
                                            ...
                                            <div class="bl-item-image-wrap">
                                                <a href="{{ route('elonlar.list') }}/{{ $elon->slug }}" class="bl-item-image bg-image lazy" data-src="{{ $elon->image }}"></a>
                                            </div>
                                            ...
                                            <div class="bl-item-info">
                                                ...
                                                <a href="{{ route('elonlar.list') }}/{{ $elon->slug }}" class="bl-item-title"><h2>
                                                        {{$elon->title}}</h2></a>
                                                ...
                                                <ul class="bl-item-attr">
                                                    <li>
                                                        ...
                                                        <a href="#" class="bl-item-comments-count" title="Read comments"><i class="fa fa-eye"></i> {{ $elon->count }}</a>
                                                        <!-- End comments count -->
                                                    </li>
                                                </ul>
