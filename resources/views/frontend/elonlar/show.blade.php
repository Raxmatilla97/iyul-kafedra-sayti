			...
			* Use class "ph-center" or "ph-right" to align page header caption.
			...
			<section id="page-header" class="ph-lg">
				...
				* Use class "hide-ph-image" to hide page header image without removing the code.
				-->
				<div class="page-header-image parallax-6 bg-image" style="background-image: url({{ $elonlar->image }});">
					...
					* Use class "fade-out-scroll-1" up to "fade-out-scroll-6" to enable fade out effect if page scrolls (no effect on mobile devices!).
					...
					<div class="page-header-caption ph-cap-lg ph-cap-light ph-cap-shadow parallax-5 fade-out-scroll-4">
						<div class="ph-title-wrap">
							<h1 class="page-header-title">{{ $elonlar->title }}</h1>
						</div>
					...
					<div class="row no-margin">
						...
						<div class="col-md-8 no-padding-left no-padding-right">
							...
							<article class="blog-single-post">
								...
								{{-- 	<div class="blog-single-post-category"><a href="/{{ $elon->cate->slug }}">{{ $yangiliklar->cate->title }}</a> </div> --}}
											...
											<div class="col-sm-8">
												...
												<div class="blog-single-meta-wrap">
													...
													<div class="blog-single-meta">
														<div class="article-author">Yozuvchi: <a href="#">{{ $elonlar->user->name }}</a></div>
														<div class="article-time-cat">
															<span class="article-time">{{ $elonlar->created_at->format('Y-m-d') }}</span>
														</div>
													</div>
											...
											<div class="col-sm-4">
												...
												<ul class="blog-single-links list-unstyled list-inline">
													<li>
														...
														<a href="blog-single.html#blog-post-comments" class="blog-single-comment-count sm-scroll" title="Read the comments"><i class="fa fa-eye"></i> {{ $elonlar->count }}</a>
														<!-- End comments count -->
													</li>
												</ul>
							...
							<div class="blog-single-nav">
								...
								<div class="bs-nav-col bs-nav-left">
									...
									<a href="/elonlar/{{ $oldingisi->slug }}" class="bs-nav-title"><h4>{{ $oldingisi->title }}</h4></a>
                                </div>
                                @endif
								@if (isset($keyingisi))
								<div class="bs-nav-col bs-nav-right">
									<div class="bs-nav-text">Bundan keyingi yangilik <i class="fas fa-angle-right"></i></div>
									<a href="/elonlar/{{ $keyingisi->slug }}" class="bs-nav-title"><h4>{{ $keyingisi->title }}</h4></a>
								</div>
								@endif
							</div>
							<!-- End blog single nav -->
							...
							<div class="related-posts">
								<h3 class="related-posts-heading">Eng mashxur e'lonlar:</h3>
										...
										<div class="cc-item">
											...
											<div class="related-posts-item">
												<div class="rp-item-image-wrap">
													<a href="/elonlar/{{ $item->slug }}" class="rp-item-image owl-lazy bg-image" data-src="{{ $item->image }}"></a>
												</div>
												<div class="rp-item-info">

													<a href="/elonlar/{{ $item->slug }}" class="rp-item-title"><h4>{{ $item->title }}</h4></a>
												</div>
											</div>
								...
								<div class="row">
									...
									<div class="col-md-12 col-sm-6">
										...
										<div class="sidebar-widget sidebar-post-list">
											<h3 class="sidebar-heading">So'ngi e'lonlar</h3>
