...
<div class="form-group col-sm-6">
    {!! Form::label('title', "Ilmiy maqolaning nomlanishi:") !!}
    {!! Form::text('title', null, ['class' => 'form-control', 'id' => 'slug-source']) !!}
</div>

<!-- Slug Field -->
<div class="form-group col-sm-6">
    {!! Form::label('slug', "Maqola manzili: O'zgartirish shart emas avtomatik kiritiladi!") !!}
    {!! Form::text('slug', null, ['class' => 'form-control', 'id' => 'slug-target']) !!}
</div>

<div class="col-md-5" style="margin-top: 20px">
    <h3 class="mt-8" style="margin-left: 10%;">Ilmiy maqola muqova suratini yuklash</h3>
...
<div class="container col-sm-12" >
    <h3 class="text-center">Ilmiy maqolaning asosiy qismi</h3>
    <hr>
...
<div class="form-group col-sm-12 text-center">
    <br>
    <br>
    {!! Form::submit('Maqolani saqlash', ['class' => 'btn btn-success']) !!}
    <a href="{{ route('ilmiyMaqolalars.index') }}" class="btn btn-danger">Yopish</a>
</div>
